...
export const OFFICE_ZONES: GeofenceZone[] = [
  { name: 'Head Office',   lat: 21.169007723509296, lng: 72.8316816282585, radiusMeters: 150 },
];

export const FACTORY_ZONES: GeofenceZone[] = [
  { name: 'Factory Unit A', lat: 21.169007723509296, lng: 72.8316816282585, radiusMeters: 200 },
];
